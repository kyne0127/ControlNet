...
# from ..unets.my_unet_2d_condition import MyUNet2DConditionModel as UNet2DConditionModel
...
class MyControlNetModel(ControlNetModel, ModelMixin, ConfigMixin, FromOriginalModelMixin):
    """
    A ControlNet model.
