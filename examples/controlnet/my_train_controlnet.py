...
from diffusers.models.controlnets import MyControlNetModel as ControlNetModel
from diffusers.models.unets import MyUNet2DConditionModel as UNet2DConditionModel
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(controlnet):
                ...
                model_pred = unet(
                    ...
                    return_dict=False,
                    alpha = np.maximum(0, 1-0.001*epoch)
                )[0]
